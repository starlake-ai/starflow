...
- **Claude Code skills**: 45+ Starflow-specific skills installed at `.claude/skills/starlake-skills/` covering all CLI commands, config patterns, and best practices